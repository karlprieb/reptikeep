...
export const Colors = {
  light: {
    ...
    accentInk: Primitives.caramel[600],
    primarySurface: "#3D2712",
    onPrimarySurface: Primitives.caramel[300],
  ...
  dark: {
    ...
    searchFieldTint: Primitives.bark[900],
    border: "#3A2C1D",
    ...
    accentInk: Primitives.caramel[400],
    primarySurface: "#3D2712",
    onPrimarySurface: Primitives.caramel[300],
